...
| `models/qwen35/adaptive-scheduler-policy.md` | Issue #727 adaptive scheduler: default `off` / opt-in `auto`, hard prefill cap, TP rejects `auto`; 4090 in-process acceptance shows auto≈off (no regression); HTTP QPS A/B re-persist pending. |
